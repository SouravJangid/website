...
if (isset($_POST['place_order'])) {
    ...
    if (isset($_GET['get_id'])) {
        ...
        $warring_msg[] = 'someting went wrong';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>MyWebsite - checkout </title>
</head>
    ...
    <div class="main">
        ...
        <section class="checkout">
            <div class="title">
                ...
                <h1>checkout summary</h1>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cumque a similique maiores culpa fuga est sed dolorum impedit illum, qui quia porro dolores.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="summary">
                    ...
                    <div class="grand_total"><span>total amount payable: <span><?= $grand_total ?>/-</span></span></div>
                </div>
            </div>
